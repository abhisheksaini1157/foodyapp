...
import com.example.foody.activity.RestaurantMenuActivity
import com.example.foody.database.RestaurantDatabase
import com.example.foody.database.RestaurantEntity
        ...
        holder.txtFavorite.setOnClickListener {
            if (!DBAsyncTask(context, restaurantEntity, 1).execute().get()) {
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_favouritered)
